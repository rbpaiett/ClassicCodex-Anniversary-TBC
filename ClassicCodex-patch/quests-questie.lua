...
C_Timer.After(8.0, function()
    ...
    local D = setmetatable({}, {
        ...
        __newindex = function(_, id, value)
            if realD[id] then realD[id] = value end
        end
    })

    -- YOUR DATA STARTS BELOW THIS LINE:
...
if D[172] and D[172].obj then
    D[172].obj.I = {18597} --old: {1923}
else
    -- If it doesn't exist, create the structure so it doesn't crash
    D[172] = D[172] or {}
    D[172].obj = D[172].obj or {}
    D[172].obj.I = {18597}
end
D[172].lvl=60 --old: 29
D[172].min=10 --old: 26
